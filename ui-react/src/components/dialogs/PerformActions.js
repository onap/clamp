...
export default class PerformActions extends React.Component {
	...
	componentDidMount() {
		...
		if (action === 'delete') {
			let confirmDelete = window.confirm('You are about to remove Control Loop Model "' + loopName + '". Select OK to continue with deletion or Cancel to keep the model.');
