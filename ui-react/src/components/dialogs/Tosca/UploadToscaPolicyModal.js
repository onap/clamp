		...
		return (
			<ModalStyled size="lg" show={this.state.show} onHide={this.handleClose}>
				...
				<Modal.Footer>
				  ...
				  {!this.state.apiResponseStatus?<Button disabled={!this.state.selectedFile.name || this.state.upldBtnClicked} variant="primary" type="submit" onClick={this.handleUpload.bind(this)}>Upload</Button>:""}
