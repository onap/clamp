...
import ViewBPTempls from './ViewBPTempls';
...
describe('Verify ViewToscaModals', () => {
	...
	it('Test API Successful', () => {
		...
		const component = shallow(<ViewBPTempls/>);
	});
  ...
  it('Test API Exception', () => {
	...
	it('Test Table icons', () => {
		...
		const component = mount(<ViewBPTempls/>);
    ...
    const handleClose = jest.spyOn(ViewBPTempls.prototype,'handleClose');
    const component = shallow(<ViewBPTempls history={historyMock} />)
