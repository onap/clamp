            ...
            <div>
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    <LoginDivStyle className={(submitted && !username ? ' has-error' : '')}>
                        ...
                        <LoginTextInput name="username" value={username} onChange={this.handleChange} />
                        {submitted && !username &&
                    ...
                    <LoginDivStyle className={(submitted && !password ? ' has-error' : '')}>
                        ...
                        <LoginTextInput type="password" name="password" value={password} onChange={this.handleChange} />
                        {submitted && !password &&
                            <div className="help-block">Password is required</div>
                        }
                    </LoginDivStyle>
                    <LoginDivStyle>
                        <LoginSubmitButton className="btn btn-primary">Login</LoginSubmitButton>
                    </LoginDivStyle>
                </form>
            </div>
        );
