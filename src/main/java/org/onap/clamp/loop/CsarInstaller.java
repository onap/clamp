...
public class CsarInstaller {
    ...
    */
    ...
    private JsonObject createGlobalPropertiesJson(BlueprintArtifact blueprintArtifact, Loop newLoop) {
        ...
        DeployParameters deployParams = new DeployParameters(blueprintArtifact, newLoop);
        globalProperties.add("dcaeDeployParameters", deployParams.getDeploymentParametersinJson());
