...
public class CsarInstaller {
    ...
    private HashSet<LoopElementModel> createMicroServiceModels(List<BlueprintMicroService> microServicesChain, CsarHandler csar,
    ...
    private PolicyModel createPolicyModel(BlueprintMicroService microService, CsarHandler csar) throws IOException {
    ...
    private PolicyModel getPolicyModel(BlueprintMicroService microService, CsarHandler csar) throws IOException {
        return policyModelsRepository.findById(new PolicyModelId(microService.getModelType(), "1.0.0"))
