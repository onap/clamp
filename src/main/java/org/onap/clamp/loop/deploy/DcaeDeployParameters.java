...
public class DcaeDeployParameters  {
    ...
    private static LinkedHashMap<String, JsonObject> init(LinkedHashSet<BlueprintArtifact> blueprintArtifactList, Loop loop) {
    ...
    private static JsonObject generateDcaeDeployParameter(BlueprintArtifact blueprintArtifact, String microServiceName) {
     ...
     */
    public static JsonObject getDcaeDeploymentParametersInJson(LinkedHashSet<BlueprintArtifact> blueprintArtifactList, Loop loop) {
