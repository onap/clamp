...
public class TcaRequestFormatter {
     ...
     */
    public static JsonObject createPolicyContent(ClampProperties refProp,
                                                 ModelProperties modelProperties, String service, String policyName, Tca tca) {
        try {
            ...
            JsonObject metricsPerEventName = rootNode.get("metricsPerEventName")
