...
public class CdsServices {
    ...
    public CdsBlueprintWorkflowInfo getWorkflowInputProperties(String blueprintName, String blueprintVersion,
                                                               String workflow) {
    ...
    private CdsBlueprintWorkflowInfo parseCdsResponse(String response) {
        // TODO parse and construct CdsBlueprintWorkflowInfo
        return new CdsBlueprintWorkflowInfo();
    }
}
