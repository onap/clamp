...
public class OperationalPolicyAttributesConstructor {
    ...
    private Map<String, String> prepareRuleAttributes(ClampProperties refProp, ModelProperties modelProperties,
        ...
        if (operationTopic == null || operationTopic.isEmpty()) {
            ...
            fillRuleAttributesFromPolicyChain(ruleAttributes, policyChain,
                    modelProperties, modelElementId, operationTopic);
        }
    ...
    private void fillRuleAttributesFromPolicyItem(Map<String, String> ruleAttributes,
                                                  PolicyItem policyItem, String recipeTopic) {
    ...
    private void fillRuleAttributesFromPolicyChain(Map<String, String> ruleAttributes, PolicyChain policyChain,
                                                   ModelProperties modelProperties, String modelElementId,
