...
public class SdcCatalogServices {
    ...
    /**
     * Return SDC id and pw as a HTTP Basic Auth string (for example: Basic dGVzdDoxMjM0NTY=).
     *
     ...
     * @throws DecoderException In case of issues with the decoding of the HexString message
     */
    ...
    /**
     * This method get the SDC services Information with the corresponding Service UUID.
     *
     ...
     *
     * @param rawCldsSdcServiceList A list of CldsSdcServiceInfo
     ...
     *
     * @param jsonStr The Json string that must be decoded
     * @return The list of CldsSdcServiceInfo, if there is a failure it return an empty list
     */
     ...
     *
     * @param cldsServiceData The object representing the service data
     * @return boolean flag
    ...
    private List<CldsAlarmCondition> getAlarmCondtionsFromVfc(String vfcResponse) throws GeneralSecurityException {
        ...
        JsonArray artifactsArrayNode = vfcResponseNode.get("artifacts").getAsJsonArray();
    ...
    /**
     * Service to services/resources/artifacts from sdc.Pass alarmConditions as true to get alarm conditons from
     * artifact url and else it is false
     *
     ...
     *
     * @param cldsServiceData CldsServiceData the Service Data to analyze
     * @param eventName The String event name that will be used to filter the alarm list
     ...
     *
     * @param currCldsVfData The Vf Data to analyze
     * @param eventName The String event name that will be used to filter the alarm list
     * @return The list of CldsAlarmCondition for the event name specified
     */
     ...
     *
     * @param currCldsVfcData The VfC Data to analyze
     * @param eventName The String event name that will be used to filter the alarm list
     * @return The list of CldsAlarmCondition for the event name specified
     */
