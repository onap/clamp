...
public class TemplateManagement {
	...
	public TemplateManagement(String pathToComponent) throws FileNotFoundException, IOException {
	 ...
	 * @param template
	 * @return
	 * Compare two templates : size and components
	 */
	...
	private LinkedHashMap<String, Template> initializeTemplates() {
		...
		ArrayList<String> fieldsActor = new ArrayList<>(Arrays.asList("type","required","entry_schema"));
		Template actor = new Template("List", fieldsActor);
		generatedTemplates.put(list.getName(), actor);
