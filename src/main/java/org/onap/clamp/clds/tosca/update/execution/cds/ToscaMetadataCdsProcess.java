    ...
    private static void addDefaultValueForData(JsonObject inputs,
        ...
        for (Map.Entry<String, JsonElement> entry : entrySet) {
            ...
            if (key.equalsIgnoreCase(workFlowName + "-properties")) {
                addDefaultValueForData(entry.getValue().getAsJsonObject().get("properties").getAsJsonObject(), defaultValue, workFlowName);
            } else if ("object".equalsIgnoreCase(inputProperty.get(TYPE).getAsString())) {
                JsonObject object = new JsonObject();
                addDefaultValueForData(entry.getValue().getAsJsonObject().get("properties").getAsJsonObject(), object, workFlowName);
