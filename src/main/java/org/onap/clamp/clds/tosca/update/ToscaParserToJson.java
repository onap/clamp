...
@Component
public class ToscaParserToJson {
    ...
    public ToscaParserToJson(LinkedHashMap<String, ToscaElement> components, LinkedHashMap<String, Template> templates) {
            ...
            switch (propertyField) {
                ...
                case "entry_schema":
                    ...
                    if (matchComponent(this.extractSpecificFieldFromMap(property, "entry_schema")) != null) {
                        ...
                        ToscaParserToJson child = new ToscaParserToJson(components, templates);
