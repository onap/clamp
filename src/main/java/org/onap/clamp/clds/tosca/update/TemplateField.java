...
public class TemplateField {
     ...
     *
     * @param o Compare the current object with the one specified
     * @return true if they are totally equals, false otherwise
     */
    public boolean compareWithField(Object o) {
        if (this == o) {
            return true;
        }
    ...
    public static boolean fieldsEquals(TemplateField templateField1, TemplateField templateField2) {
        return (templateField2.getTitle().equals(templateField1.getTitle()) && templateField2
                .getValue().equals(templateField1.getValue())
                && templateField2.getVisible().equals(templateField1.getVisible()) && templateField2
                .getStaticValue().equals(templateField1.getStaticValue()));
    }
