...
public final class ResourceFileUtils {
     ...
     * So here we want to eliminate classpath: prefix, so that this class can get files from jar resource or file system.
     */
     ...
     *
     * @param fileName The path of the resource (no prefix it will be a classpath access, "classpath:/myfilename" or "file:/myfilename")
