...
class ClosedLoopController {
    ...
    Loop createEmptyLoop(){
        return closedLoopService.createEmptyClosedLoop("testLoopName", "testLoopBluepritn", "testLoopSVG" );
    }
    ...
    Loop updateOperationalPolicies(@PathVariable String loopName, @RequestBody List<OperationalPolicy> operationalPolicies){
    ...
    Loop updateMicroservicePolicies(@PathVariable String loopName, @RequestBody List<MicroServicePolicy> microServicePolicies){
        return closedLoopService.updateMicroservicePolicies(loopName, microServicePolicies);
    }

//    @PostMapping("updateGlobalLoopParameters")
//    Loop updateGlobalLoopParameters(){
//
//    }
}
