...
public class CamelConfiguration extends RouteBuilder {
    ...
    private void configureDefaultSslProperties() throws IOException {
        if (env.getProperty("server.ssl.trust-store") != null) {
            ...
            String trustStorePass = PassDecoder.decode(env.getProperty("server.ssl.trust-store-password"), new ByteArrayInputStream(bytes));
            ...
            String keyStorePass = PassDecoder.decode(env.getProperty("server.ssl.key-store-password"), new ByteArrayInputStream(bytes));
