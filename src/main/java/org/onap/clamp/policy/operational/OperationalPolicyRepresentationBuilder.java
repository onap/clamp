...
public class OperationalPolicyRepresentationBuilder {
     ...
     */
    public static JsonObject generateOperationalPolicySchema(Service modelJson, LoopType loopType)
        throws JsonSyntaxException, IOException {
        JsonObject jsonSchema;
        if (loopType != null && loopType.equals(LoopType.OPEN)) {
            jsonSchema = JsonUtils.GSON.fromJson(
                ResourceFileUtil.getResourceAsString(
                    "clds/json-schema/operational_policies/open_loop_operational_policy.json"),
                JsonObject.class);
        } else {
            jsonSchema = JsonUtils.GSON.fromJson(
                ResourceFileUtil.getResourceAsString(
