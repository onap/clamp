...
public class SvgLoopGeneratorTest {
    private Loop getLoop() {
        MicroServicePolicy ms1 = new MicroServicePolicy("ms1", new PolicyModel("org.onap.ms1", "","1.0.0","short.ms1"),
                false,
                new HashSet<Loop>());
        MicroServicePolicy ms2 = new MicroServicePolicy("ms2", new PolicyModel("org.onap.ms2", "","1.0.0","short.ms2"),
                false,
        new HashSet<Loop>());
