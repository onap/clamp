...
public class MockPermission {
    ...
    private final Map<String, Map> mockPermission;
    ...
    public MockPermission(){
        ...
        this.mockPermission = ImmutableMap.of(
                "mockPermission-type-cl", ImmutableMap.of(
                        "dev", ALL_ACTION
                ),
                "mockPermission-type-cl-event", ImmutableMap.of(
                        "dev", ALL_ACTION,
                        "test", READ_UPDATE_ACTION
                ),
                "mockPermission-type-cl-manage", ImmutableMap.of(
                        "dev", ALL_ACTION,
                        "test", READ_UPDATE_ACTION
                ),
                "mockPermission-type-filter-vf", ImmutableMap.of(
                        "dev", ALL_ACTION,
                        "test", READ_UPDATE_ACTION
                ),
                "mockPermission-type-template", ImmutableMap.of(
                        "dev", ALL_ACTION,
                        "test", READ_UPDATE_ACTION
                )
        );
    ...
    public MockPermission(Map<String, Map> mockPermission) {
        this.authList = new LinkedList<>();
        this.mockPermission = mockPermission;
        this.createAuthList();
    }

    public Map<String, Map> getMockPermission() {
        return mockPermission;
    }

    private void createAuthList(){
        mockPermission.forEach((type, instanceMap) -> {
