...
public class AuthorizationControllerItCase {
    ...
    public void setupBefore() {
        ...
        mockPermission.setupMockEnv(env);
        List<GrantedAuthority> authList = mockPermission.getAuthList();
    ...
    public void testIsUserPermitted() {
        ...
        assertTrue(auth.isUserPermitted(new SecureServicePermission("mockPermission-type-cl","dev","read")));
        assertTrue(auth.isUserPermitted(new SecureServicePermission("mockPermission-type-cl-manage","dev","DEPLOY")));
        assertTrue(auth.isUserPermitted(new SecureServicePermission("mockPermission-type-filter-vf","dev","12345-55555-55555-5555")));
        assertFalse(auth.isUserPermitted(new SecureServicePermission("mockPermission-type-cl","test","read")));
    }
    ...
    public void testIfUserAuthorize(){
        ...
        try {
            mockPermission.doActionOnAllPermissions(((type, instance, action) ->
    ...
    public void testIfAuthorizeThrowException(){
        ...
        auth.authorize(ex,"mockPermission-type-cl","test","read");
    }
}
