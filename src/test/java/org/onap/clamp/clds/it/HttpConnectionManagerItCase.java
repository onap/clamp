...
public class HttpConnectionManagerItCase {
    ...
    public void testHttpsGet404() throws IOException {
        httpConnectionManager.doHttpRequest("https://localhost:" + this.httpsPort + "/swagger.html", "GET", null, null,
                "DCAE", null, null);
    ...
    public void testHttpsPost404() throws IOException {
        httpConnectionManager.doHttpRequest("https://localhost:" + this.httpsPort + "/swagger.html", "POST", "",
