...
public class TemplateManagementTest extends TestCase {
	...
	public void testIsEmpty() throws FileNotFoundException, IOException {
		String componentFilePath = "dontExist.yaml";
		...
		componentFilePath = "base.xml";
		templateManagment = new TemplateManagement(componentFilePath,templateFilePath);
		assertNull(templateManagment.getComponents());
	}
	...
	public void testGetAllAttributes() throws FileNotFoundException, IOException{
		...
		String templateFilePath = "templates.properties";
		TemplateManagement templateManagment = new TemplateManagement(componentFilePath,templateFilePath);
		assertEquals(6,templateManagment.getComponents().size());
		Extractor extractor = new Extractor(componentFilePath);
	...
	public void testCRUDTemplate() throws FileNotFoundException, IOException {
		...
		assertEquals(templateManagment.getTemplates().size(), 6);
		//AddTemplate
	...
	public void testLaunchProcess() throws FileNotFoundException, IOException, UnknownComponentException {
		String componentFilePath = "final.yaml";
		String templateFilePath = "templates.properties";
		TemplateManagement templateManagment = new TemplateManagement(componentFilePath,templateFilePath);
