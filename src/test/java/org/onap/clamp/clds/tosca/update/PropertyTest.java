...
public class PropertyTest extends TestCase {
    ...
    public void testParseArray() throws IOException {
        TemplateManagement templateManagement = new TemplateManagement("sampleOperationalPoliciesEXTENTED.yaml","templates.properties");
    ...
    public void testAddConstraintsAsJson() throws IOException {
        TemplateManagement templateManagement = new TemplateManagement("sampleOperationalPolicies.yaml","templates.properties");
