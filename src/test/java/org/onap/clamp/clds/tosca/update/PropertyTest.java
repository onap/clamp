...
public class PropertyTest extends TestCase {
    ...
    public void testParseArray() throws IOException {
        TemplateManagement templateManagement = new TemplateManagement("finalMODIFIED.yaml","templates.properties");
    ...
    public void testAddConstraintsAsJson() throws IOException {
        TemplateManagement templateManagement = new TemplateManagement("final.yaml","templates.properties");
