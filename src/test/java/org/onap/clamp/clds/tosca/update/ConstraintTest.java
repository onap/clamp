...
public class ConstraintTest extends TestCase {
    ...
    ToscaTemplateManager toscaTemplateManager = new ToscaTemplateManager(
    ...
    ToscaElement toscaElement = toscaTemplateManager.getComponents().get("onap.datatype.controlloop.Operation");
    ...
    public void testGetValuesArray() {
        ...
        Template template = toscaTemplateManager.getTemplates().get("integer");
        ...
        template = toscaTemplateManager.getTemplates().get("string");
    ...
    public void testGetSpecificLength() {
        ...
        Template template = toscaTemplateManager.getTemplates().get("string");
        JsonObject resultProcess = new JsonObject();
        property.addConstraintsAsJson(resultProcess, (ArrayList<Object>) property.getItems().get("constraints"),
                template);
    ...
    public void testGetLimitValue() {
        ...
        Template template = toscaTemplateManager.getTemplates().get("array");
        JsonObject resultProcess = new JsonObject();
        property.addConstraintsAsJson(resultProcess, (ArrayList<Object>) property.getItems().get("constraints"),
                template);
