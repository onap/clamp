...
public class DcaeDispatcherServicesTest {
    ...
    private static final String DEPLOY_RESPONSE_STRING = "{\"links\":" +
            ...
            "closedLoop_152367c8-b172-47b3-9e58-c53add75d869_deploymentId/operation/366eb098-7977-4966-ae82-abd2087edb10\"}}";
    ...
    public void shouldTriggerDeploymentCreation() throws IOException {
        ...
        //when
        String operationStatus = dcaeDispatcherServices.createNewDeployment(deploymentID, serviceTypeId, blueprintInputJson);
