...
public class CldsInfoProviderTest {
    ...
    public void shouldProvideCldsInfoFromContext() throws Exception {
        ...
        assertThat(cldsInfo.isPermissionReadCl()).isEqualTo(true);
        assertThat(cldsInfo.isPermissionReadTemplate()).isEqualTo(true);
        assertThat(cldsInfo.isPermissionUpdateCl()).isEqualTo(true);
        assertThat(cldsInfo.isPermissionUpdateTemplate()).isEqualTo(true);
    }
}