...
public class DictionaryServiceItCase {
    ...
    private DictionaryElement getDictionaryElement(String shortName, String name,
        String description, String type, Dictionary subDictionaryName) {
    ...
    @Test
    @Transactional
    public void shouldReturnNullDictionary() {
        Dictionary returnedDictionary = dictionaryService.getDictionary("Test");
        assertNull(returnedDictionary);
    }
    ...
    public void shouldDeleteDictionaryByObject() {
        ...
        Dictionary deletedDictionary = dictionaryService.getDictionary("Dictionary1");
        assertNull(deletedDictionary);
    }
