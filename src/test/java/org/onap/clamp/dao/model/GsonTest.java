...
public class GsonTest {
    ...
    public void DecodeEncodeTest() {
        ...
        opPolicy.setConfigurationsJson(new Gson().fromJson("{\"testname\":\"testvalue\"}", JsonObject.class));
//        opPolicy.setLoop(loopTest);
        loopTest.addOperationalPolicy(opPolicy);

        MicroServicePolicy µService = new MicroServicePolicy();
        µService.setJsonRepresentation(new Gson().fromJson("{\"testrepresentation\":\"value\"}", JsonObject.class));
        µService.setPolicyTosca("tosca");
        µService.setProperties(new Gson().fromJson("{\"testparam\":\"testvalue\"}", JsonObject.class));
