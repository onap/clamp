...
public class PolicyEngineControllerTestItCase {
    ...
    public void downloadPdpGroupsTest() throws JsonSyntaxException, IOException, InterruptedException, ParseException {
        ...
        PolicyModel policy1 = policyModelsRepository.getOne(new PolicyModelId("onap.policies.monitoring.test", "1.0.0"));
        PolicyModel policy2 = policyModelsRepository.getOne(new PolicyModelId("onap.policies.controlloop.Operational", "1.0.0"));
