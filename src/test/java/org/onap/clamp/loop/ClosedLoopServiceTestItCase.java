...
public class ClosedLoopServiceTestItCase {
    ...
    public void shouldAddOperationalPolicyToLoop() {
        ...
        //when
        Loop actualLoop = closedLoopService
    ...
    public void shouldCreateNewMicroservicePolicyAndUpdateJsonRepresentationOfOldOne() {
        ...
        closedLoopService.updateMicroservicePolicies(EXAMPLE_LOOP_NAME, Lists.newArrayList(firstMicroServicePolicy));
        ...
        Loop actualLoop = closedLoopService.updateMicroservicePolicies(EXAMPLE_LOOP_NAME,
    ...
    public void shouldCreateNewOperationalPolicyAndUpdateJsonRepresentationOfOldOne() {
        ...
        closedLoopService.updateOperationalPolicies(EXAMPLE_LOOP_NAME, Lists.newArrayList(firstOperationalPolicy));
        ...
        Loop actualLoop = closedLoopService.updateOperationalPolicies(EXAMPLE_LOOP_NAME,
        ...
        assertThat(savedPolicies).extracting("loop")
            .containsExactlyInAnyOrder(EXAMPLE_LOOP_NAME, EXAMPLE_LOOP_NAME);
    }
