...
public class PolicyModelServiceItCase {
    ...
    @Transactional
    public PolicyModel savePolicyModel(PolicyModel policyModel) {
        return policyModelsService.saveOrUpdatePolicyModel(policyModel);
    }
    ...
    public void shouldCreatePolicyModel() {
        ...
        // when
        PolicyModel actualPolicyModel = savePolicyModel(policyModel);
        ...
        assertThat(actualPolicyModel.getCreatedBy()).isEqualTo(policyModel.getCreatedBy());
        ...
        assertThat(actualPolicyModel.getUpdatedBy()).isEqualTo(policyModel.getUpdatedBy());
