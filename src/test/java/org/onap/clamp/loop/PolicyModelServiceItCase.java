...
public class PolicyModelServiceItCase {
    ...
    public void shouldAddPdpGroupInfo() {
        ...
        JsonArray res1 = policyModelsService.getPolicyModel("org.onap.testos", "1.0.0").getPolicyPdpGroup();
        String expectedRes1 = "[{\"pdpGroup1\":[\"subGroup1\"]},{\"pdpGroup2\":[\"subGroup1\"]}]";
        JsonArray expectedJson1 = JsonUtils.GSON.fromJson(expectedRes1, JsonArray.class);
        assertThat(res1).isEqualTo(expectedJson1);

        JsonArray res2 = policyModelsService.getPolicyModel("org.onap.testos2", "2.0.0").getPolicyPdpGroup();
        String expectedRes2 = "[{\"pdpGroup1\":[\"subGroup1\"]},{\"pdpGroup2\":[\"subGroup1\",\"subGroup2\"]}]";
        JsonArray expectedJson2 = JsonUtils.GSON.fromJson(expectedRes2, JsonArray.class);
        assertThat(res2).isEqualTo(expectedJson2);

        JsonArray res3 = policyModelsService.getPolicyModel("org.onap.testos3", "1.0.0").getPolicyPdpGroup();
