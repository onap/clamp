...
public class PolicyComponentTest {
    ...
    */
     ...
     */
    @Test
    public void createPoliciesPayloadPdpGroupTest() {
        ...
        OperationalPolicy opPolicy = new OperationalPolicy("opPolicy", loopTest, new Gson().fromJson("{\"configtype\":\"json\"}", JsonObject.class), policyModel2);
