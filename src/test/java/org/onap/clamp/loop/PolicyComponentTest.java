...
public class PolicyComponentTest {
    ...
    public void createPoliciesPayloadPdpGroupTest() throws IOException {
        ...
        OperationalPolicy opPolicy = new OperationalPolicy("opPolicy", new Gson().fromJson("{\"configtype\":\"json\"}", JsonObject.class),
                new Gson().fromJson("{\"jsonschema\":\"schema\"}", JsonObject.class),policyModel2, null, "pdpGroup2",
                "pdpSubgroup2");
