...
import org.onap.clamp.policy.microservice.MicroServicePolicyRepository;
...
public class LoopRepositoriesItCase {
    ...
    @Transactional
    private Loop saveThat(Loop loop) {
    ...
    public void crudTest() {
        ...
        Loop loopInDb = saveThat(loopTest);
        ...
        loopInDbRetrieved.setUpdatedBy("tester2");
        Loop loopInDbRetrievedUpdated = saveThat(loopInDbRetrieved);
        ...
        assertThat(loopInDbRetrievedUpdated.getUpdatedDate()).isNotEqualTo(loopInDb.getUpdatedDate());
        ...
        assertThat(loopInDbRetrievedUpdated.getCreatedBy()).isEqualTo(loopTest.getCreatedBy());
        assertThat(loopInDbRetrievedUpdated.getUpdatedBy()).isNotEqualTo(loopTest.getUpdatedBy());
        ...
        servicesRepository.delete(loopInDb.getModelService());
        microServiceModelsRepository
                .delete(loopInDb.getLoopTemplate().getMicroServiceModelUsed().first().getMicroServiceModel());
        policyModelsRepository.delete(policyModelsRepository.findById(new PolicyModelId(
                loopInDb.getLoopTemplate().getMicroServiceModelUsed().first().getMicroServiceModel().getPolicyModel()
                        .getPolicyModelType(),
                loopInDb.getLoopTemplate().getMicroServiceModelUsed().first().getMicroServiceModel().getPolicyModel()
                        .getVersion()))
