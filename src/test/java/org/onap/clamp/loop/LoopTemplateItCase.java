...
public class LoopTemplateItCase {
    ...
    private static final String OPEN_LOOP_TYPE = "open";
    ...
    public void shouldReturnLoopemplate() {
        ...
        SortedSet<LoopTemplateLoopElementModel> loopElementModelsUsed = loopTemplate.getLoopElementModelsUsed();
        LoopTemplateLoopElementModel loopTemplateLoopElementModel = loopElementModelsUsed.first();
        assertThat(loopTemplateLoopElementModel.getLoopElementModel().getName()).isEqualTo("microService1");
        assertThat(loopTemplateLoopElementModel.getLoopTemplate().getName()).isEqualTo("TemplateName");
    }
